...
import render from '@/utils/generator/render.js'
    ...
    colFormItem(h, scheme) {
        ...
        return (
            <el-col span={config.span}>
                <el-form-item label-width={labelWidth} prop={scheme.vModel}
...
function renderFormItem(h, elementList) {
    return elementList.map(scheme => {
        ...
        const layout = layouts[scheme.layout]

        if (layout) {
            return layout.call(this, h, scheme)
        }
        throw new Error(`没有与${scheme.layout}匹配的layout`)
    })
}
